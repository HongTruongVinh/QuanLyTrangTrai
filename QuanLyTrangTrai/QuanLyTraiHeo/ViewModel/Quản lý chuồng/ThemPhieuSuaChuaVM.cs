...
namespace QuanLyTraiHeo.ViewModel
{
    public class ThemPhieuSuaChuaVM : BaseViewModel
    {
        ...
        private ObservableCollection<NHANVIEN> _ListLoaiChuong;
        string _MaNhanVien = "";
        string _NgaySuaChua = "";
        string _GhiChu = "";
        string _TrangThai = "";
        ...
        public ThemPhieuSuaChuaVM()
        {
            ...
            {
                var phieuSuaChua = new PHIEUSUACHUA() {MaNhanVien = MaNhanVien, NgaySuaChua = DateTime.Parse(NgaySuaChua), GhiChu = GhiChu, TrangThai = TrangThai, TongTien = Convert.ToInt32(TongTien)};
